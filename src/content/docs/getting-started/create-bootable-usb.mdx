...
<meta http-equiv="refresh" content="0; url=https://rengeos.github.io/getting-started/create-bootable-usb/" />
...
## After completing the creation of the bootable USB

**After** we have created the bootable USB, now choose the installation method corresponding to the ISO Edition you have flashed.

import { LinkCard } from '@astrojs/starlight/components';

+ **Minimal Edition Installation**:

<LinkCard title="Minimal ISO Installation" href="/rengeos-docs/installation/minimal-iso-installation/" />

- **NiriWM Edition Installation**:

<LinkCard title="NiriWM ISO Installation" href="/rengeos-docs/installation/niriwm-iso-installation/" />
