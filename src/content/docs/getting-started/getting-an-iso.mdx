...
<CardGrid>
  ...
  <Card title="Github Release (Latest)" icon="cloud-download">
    Obtain an ISO here: <a href="/rengeos-docs/getting-started/getting-an-iso/#download-from-github-and-combine-each-iso-part" target="_blank" rel="noopener noreferrer">Instruction</a>
  </Card>
</CardGrid>
