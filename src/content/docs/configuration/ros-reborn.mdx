---
title: ROS-Reborn (Recovery Mode)
---

<meta http-equiv="refresh" content="0; url=https://rengeos.github.io/configuration/ros-reborn/" />
...
![11](../../../assets/example-ros-reborn/11.png)
...
## Update airootfs and kernels for ``ros-reborn`` tool

- **RengeOS** not only allows you to **reinstall the system** directly on your device without needing a **Live ISO** or **USB**, but it also lets you download the latest airootfs and kernels from the newest **RengeOS ISO** release.

+ **You** can read more about how to use this feature here:

<LinkCard title="ROS-Reborn-System-OTA (Recovery Mode)" href="/rengeos-docs/configuration/ros-reborn-system-ota/" />
